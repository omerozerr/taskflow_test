...
const TaskList = () => {
                ...
                if (storedTasks) {
                    ...
                    const mockTasks = [
                        ...
                        },
                        {
                            ...
                            description:
                                "Add the user feedback form to the dashboard",
                            status: "incomplete",
                            priority: "low",
                            dueDate: new Date(
                                Date.now() + 86400000
    ...
    // Whenever tasks, statusFilter or searchTerm change, recompute filteredTasks
    useEffect(() => {
        let temp = [...tasks];
        ...
        // 2) Filter by title search
        if (searchTerm.trim()) {
            const q = searchTerm.toLowerCase();
            temp = temp.filter((t) => t.title.toLowerCase().includes(q));
        }
